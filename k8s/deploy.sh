...
export NAME=airbyte-specific-provisioner
export IMAGE_NAME=registry.gitlab.com/agilefactory/witboost.mesh/provisioning/sandbox/witboost.mesh.provisioning.sandbox.airbytespecificprovisioner
